...
<head>
	...
	<title>BGIET HOSTEL REGISTRATION</title>
...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: red" text-align="center">Hostel already booked by you</h3>
...
<label class="col-sm-4 control-label"><h4 style="color: green" text-align="left">Room Related info </h4> </label>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label"><h4 style="color: green" text-align="left">Personal info </h4> </label>
</div>
...
<div class="form-group">
<label class="col-sm-3 control-label"><h4 style="color: green" text-align="left">Correspondense Address </h4> </label>
</div>
...
<div class="form-group">
<label class="col-sm-3 control-label"><h4 style="color: green" text-align="left">Permanent Address </h4> </label>
</div>
